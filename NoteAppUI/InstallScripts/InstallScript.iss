...
[Icons]
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon;IconFilename: "C:\Users\User\source\repos\EmarianMerigold\NoteApp\NoteAppUI\InstallScripts\Icon.ico"
